  ...
  return (
    <View style={{height: 320, width: '90%', marginHorizontal: '5%'}}>
      ...
      <View style={{position: 'absolute', marginTop: '20%', marginLeft: '30%'}}>
        ...
        <Text
          style={{alignSelf: 'center', top: 10, color: Colours.TextDarkColour}}>
          {Datas[0].sign}
        </Text>
      </View>
      ...
      <View style={{position: 'absolute', marginTop: '40%', marginLeft: '5%'}}>
        ...
        <Text
          style={{color: Colours.TextDarkColour, alignSelf: 'center', top: 10}}>
          {Datas[3].sign}
        </Text>
      </View>
      ...
      <View
        ...
        <Text style={{position: 'absolute', alignSelf: 'center', left: 40}}>
          {Datas[4].sign}
        </Text>
      </View>
      ...
      <View style={{position: 'absolute', marginTop: '55%', marginLeft: '30%'}}>
        <Text style={{alignSelf: 'center', color: Colours.TextDarkColour}}>
          {Datas[6].sign}
        </Text>
        <View style={{flexDirection: 'row'}}>
      ...
      <View
        ...
        <View style={{alignSelf: 'center', flexDirection: 'row'}}>
          {Datas[11].planet_small.map(item => (
            <Text style={{color: 'black'}}>{item},</Text>
          ))}
        </View>
        <Text
